SELECT info.cardno, info.ENMNAME_BANGLA, info.DESIGNATION_BANGLA, info.DEPT_BANGLA, info.SEC_BANGLA, info.BIRTH_DATE
	   info.SALARY_GRADE, info.PERMANENTADDRESS, info.HOUSBANDNAME, INFO.COMPANY, SIGN.EMPSIGN, info.JOINING_DATE,
	   (info.grosssalary + info.GROSS_BK) grosssalary
FROM  TB_PERSONAL_INFO info, TB_PERSONAL_INFO_OTHER other, TB_PERSONAL_INFO_SIGN SIGN
