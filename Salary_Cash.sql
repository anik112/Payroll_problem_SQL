SELECT sal.cardno, sal.departmentnm, sal.dept_bangla, sal.sectionnm, sal.sec_bangla, sal.lineno, sal.floorno, sal.machineno,
	   ...
	   sal.netpayable_ch, sal.advance_amt_ch, sal.adv_sal_ch,(sal.advance_amt_ch+sal.adv_sal_ch)total_advance, sal.stamp_ch,  sal.netpayment_ch,
	   sal.netpayment_ch_rd,per.cash_type,  per.bank_name,  per.ac_no, per.mft_type,  per.mft_acno 
