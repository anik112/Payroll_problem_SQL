...
SELECT sal.cardno, sal.empname, sal.enmname_bangla, sal.designation, sal.designation_ban,  (sal.basicsal_ch + sal.basicsal_bk)basicsal, 
              (sal.grosssal_ch + grosssal_bk)grosssal, sal.departmentnm,  sal.dept_bangla,  sal.lineno, sal.sectionnm, sal.sec_bangla, sal.otrate, 
               mon.OTHR_HNM, per.joining_date, per.shift, mon.OTHR_PART
FROM   TB_MONTH_SALARY sal,TB_MONTH_TOTALDAY  mon, TB_PERSONAL_INFO per 
WHERE  mon.company  = :p_company 
AND    sal.company        = per.company
AND    mon.company      = per.company   
...
SELECT sal.cardno, sal.empname, sal.enmname_bangla, sal.designation, sal.designation_ban,  (sal.basicsal_ch + sal.basicsal_bk)basicsal, (sal.grosssal_ch + grosssal_bk)grosssal, 
               sal.departmentnm,  sal.dept_bangla,  sal.lineno, sal.sectionnm, sal.sec_bangla, sal.otrate, mon.OTHR_PART, per.joining_date, per.shift, mon.OTHR_PART_PT, mon.OTHR_HNM
FROM   TB_MONTH_SALARY sal,TB_MONTH_TOTALDAY  mon, TB_PERSONAL_INFO per 
WHERE  mon.company  = :p_company 
AND    sal.company        = per.company
AND    mon.company      = per.company   
...
SELECT sal.cardno, sal.empname, sal.enmname_bangla, sal.designation, sal.designation_ban,  (sal.basicsal_ch + sal.basicsal_bk)basicsal, (sal.grosssal_ch + grosssal_bk)grosssal, 
               sal.departmentnm,  sal.dept_bangla,  sal.lineno, sal.sectionnm, sal.sec_bangla, sal.otrate, mon.OTHR_PART, per.joining_date, per.shift, mon.OTHR_PART_PT
FROM   TB_MONTH_SALARY sal,TB_MONTH_TOTALDAY  mon, TB_PERSONAL_INFO per 
WHERE  mon.company  = :p_company 
AND    sal.company        = per.company
AND    mon.company      = per.company   
