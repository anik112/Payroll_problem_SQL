...
--  RECOVER COMPARE WITH OTHER TABLE

SELECT * FROM TB_PERSONAL_INFO AS OF TIMESTAMP TO_TIMESTAMP('20-OCT-2019 10:00:00', 'DD-MON-YYYY HH24:MI:SS')
WHERE CARDNO IN (SELECT CARDNO FROM TB_PERSONAL_INFO WHERE ACTIVE=0) AND LENGTH(SECRETENO)=8