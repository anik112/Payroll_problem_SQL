SELECT sal.cardno, sal.departmentnm, sal.dept_bangla, sal.sectionnm, sal.sec_bangla, sal.lineno, sal.floorno, sal.machineno,
	   ...
	   mon.total_attn_day, sal.grosssal_bk, sal.basicsal_bk, sal.houserent_bk,sal.medical medical_sal, sal.transport, sal.foodallow, sal.otherallow_bk,	
	   ...
	   sal.netpayment_bk, sal.netpayment_bk_rd,per.cash_type,  per.bank_name,  per.ac_no, per.mft_type,  per.mft_acno 
