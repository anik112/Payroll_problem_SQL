SELECT COUNT(DISTINCT CARDNO) FROM TB_DATA_MASTER
WHERE COMPANY=2
AND FINYEAR=2019
...
CURSOR EMP_LIST IS
	   SELECT OUTTIME FROM TB_DATA_MASTER
	   WHERE COMPANY=2
	   AND FINYEAR=2019
	   AND FINMONTH='January'
	   AND PDATE=TO_DATE('01/04/2019','MM/DD/YYYY');
...
LOOP
	...
	END IF;
END LOOP;
DBMS_OUTPUT.PUT_LINE('OUT TIME BETWEEN 09 TO 11: '||C_OUT09TO11);
