SELECT DEPARTMENTNM, SECTIONNM, lineno, cardno, empname, designation, BIRTH_DATE, joining_date,  (grosssalary + GROSS_BK)grosssalary
...
SELECT info.DEPARTMENTNM, info.SECTIONNM, info.lineno, info.cardno, info.empname, info.designation,
       info.BIRTH_DATE, info.joining_date, (info.grosssalary + info.GROSS_BK)grosssalary
