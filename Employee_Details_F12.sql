SELECT DEPARTMENTNM, SECTIONNM, lineno, cardno, empname, designation, SALARY_GRADE, joining_date, (grosssalary + GROSS_BK) grosssalary
...
info.SALARY_GRADE, info.joining_date, (info.grosssalary + info.GROSS_BK) grosssalary
