SELECT SECTIONNM,DEPARTMENTNM, lineno, cardno, empname, designation, BIRTH_DATE, joining_date, (grosssalary + GROSS_BK) grosssalary, OTHERS TUS   
...
info.BIRTH_DATE, info.joining_date, (info.grosssalary + info.GROSS_BK) grosssalary,  info.OTHERS TUS
