SELECT cardno, empname, joining_date, designation, WORKERTYPE,
(GROSSSALARY + GROSS_BK) grosssalary, lineno, SECTIONNM, DEPARTMENTNM
...
AND    active  LIKE DECODE(NVL(:p_active,'all'),'all','%',:p_active)
UNION
SELECT emp.cardno, emp.empname, emp.joining_date, emp.designation, emp.WORKERTYPE,
(emp.GROSSSALARY + emp.GROSS_BK) grosssalary, emp.lineno, emp.SECTIONNM, emp.DEPARTMENTNM
