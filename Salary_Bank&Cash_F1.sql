SELECT sal.cardno, sal.departmentnm, sal.dept_bangla, sal.sectionnm, sal.sec_bangla, sal.lineno, sal.floorno, sal.machineno,
       ...
       mon.total_attn_day,sal.medical medical_sal, sal.transport, sal.foodallow, sal.otherallow_bk, mon.late_day, mon.sal_ot_hr,   sal.otrate,
       ...
       (sal.stamp_ch + sal.stamp_bk)stamp, 
