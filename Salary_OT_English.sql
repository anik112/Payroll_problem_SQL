SELECT sal.DEPARTMENTNM, sal.DEPT_BANGLA, sal.SECTIONNM, sal.SEC_BANGLA, sal.LINENO, sal.FLOORNO, sal.MACHINENO, per.CARDNO, per.ENMNAME_BANGLA, per.JOINING_DATE, 
       per.RESIGNATION_DATE, sal.DESIGNATION_BAN, sal.SALARY_GRD, mon.TOTAL_DAY, mon.TOTAL_LEAVE, mon.TOTAL_PRESENT, mon.TOTAL_ABSENT, sal.EMPNAME,
       ...
       (sal.NETPAYMENT_CH_RD + sal.NETPAYMENT_BK_RD)NETPAYMENT_RD, SIGN.EMPSIGN
...
SELECT sal.DEPARTMENTNM, sal.DEPT_BANGLA, sal.SEC_BANGLA, sal.LINENO, sal.FLOORNO, sal.MACHINENO, per.CARDNO, per.ENMNAME_BANGLA, per.JOINING_DATE, 
       per.RESIGNATION_DATE, sal.DESIGNATION_BAN, sal.SALARY_GRD, mon.TOTAL_DAY, mon.TOTAL_LEAVE, mon.TOTAL_PRESENT, mon.TOTAL_ABSENT, sal.SECTIONNM,
       mon.LATE_DAY, sal.MEDICAL, sal.TRANSPORT, sal.FOODALLOW, sal.OTHERALLOW_BK, mon.SAL_OT_HR, sal.OTRATE, mon.TOTAL_HOLIDAY, sal.EMPNAME,sal.DESIGNATION,
       (sal.GROSSSAL_CH + sal.GROSSSAL_BK)GROSSSAL, 
       (sal.BASICSAL_CH + sal.BASICSAL_BK)BASICSAL, 
       (sal.HOUSERENT_CH + sal.HOUSERENT_BK)HOUSERENT,
       (sal.TOTAL_ABSENT_DED_CH + sal.TOTAL_ABSENT_DED_BK)TOTAL_ABSENT_DED,
...
SELECT sal.DEPARTMENTNM, sal.DEPT_BANGLA, sal.SEC_BANGLA, sal.LINENO, sal.FLOORNO, sal.MACHINENO, per.CARDNO, per.ENMNAME_BANGLA, per.JOINING_DATE, 
	   ...
	   (sal.FS_BONUS_CH + sal.FS_BONUS_BK)FS_BONUS,SIGN.EMPSIGN
FROM  TB_MONTH_SALARY sal,TB_MONTH_TOTALDAY  mon, TB_PERSONAL_INFO per, TB_PERSONAL_INFO_SIGN SIGN
WHERE mon.company  = :p_company 
AND   mon.company      = sal.company 
AND   mon.company      = per.company 
...
SELECT sal.DEPARTMENTNM, sal.DEPT_BANGLA, sal.SECTIONNM, sal.SEC_BANGLA, sal.LINENO, sal.FLOORNO, sal.MACHINENO, per.CARDNO, per.ENMNAME_BANGLA, per.JOINING_DATE, 
       per.RESIGNATION_DATE, sal.DESIGNATION_BAN, sal.SALARY_GRD, mon.TOTAL_DAY, mon.TOTAL_LEAVE, mon.TOTAL_PRESENT, mon.TOTAL_ABSENT, sal.EMPNAME,
       mon.LATE_DAY, sal.MEDICAL, sal.TRANSPORT, sal.FOODALLOW, sal.OTHERALLOW_BK, mon.SAL_OT_HR, sal.OTRATE, mon.TOTAL_HOLIDAY,sal.DESIGNATION,
       (sal.GROSSSAL_CH + sal.GROSSSAL_BK)GROSSSAL, 
       (sal.BASICSAL_CH + sal.BASICSAL_BK)BASICSAL, 
       (sal.HOUSERENT_CH + sal.HOUSERENT_BK)HOUSERENT,
       (sal.TOTAL_ABSENT_DED_CH + sal.TOTAL_ABSENT_DED_BK)TOTAL_ABSENT_DED,
