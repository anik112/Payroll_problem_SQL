SELECT sal.cardno, sal.departmentnm, sal.dept_bangla, sal.sectionnm, sal.sec_bangla, sal.lineno, sal.floorno, sal.machineno,
	   ...
	   sal.arrear_amt_ch, sal.netpayable_ch, sal.advance_amt_ch, sal.adv_sal_ch,  (sal.advance_amt_ch+sal.adv_sal_ch)total_advance, sal.stamp_ch,  
       sal.netpayment_ch, sal.netpayment_ch_rd, sal.nt_bill_ch, sal.nt_bill_pt_ch, (sal.nt_bill_ch + sal.nt_bill_pt_ch)nt_bill,  sal.tiffin_bill_ch,
       sal.tiffin_bill_pt_ch,  (sal.tiffin_bill_ch + sal.tiffin_bill_pt_ch)tiffin_bill, sal.iftar_bill_ch, sal.dinner_bill_ch,  sal.gt_holi_bill_ch, 
       sal.wk_holi_bill_ch, per.cash_type,  per.bank_name,  per.ac_no, per.mft_type,  per.mft_acno 
