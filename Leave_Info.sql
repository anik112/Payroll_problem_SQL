SELECT per.cardno,per.empname,per.designation,per.floorno,per.machineno,levinfo.leave_type,levinfo.start_date,
levinfo.end_date,levinfo.reason,per.sectionnm,per.departmentnm ,levinfo.salday, per.lineno
