SELECT sal.cardno, sal.empname, sal.enmname_bangla, sal.designatio, sal.designation_ban,  (sal.basicsal_ch + sal.basicsal_bk)basicsal, 
       (sal.grosssal_ch + grosssal_bk)grosssal, sal.otamount, sal.departmentnm,  sal.dept_bangla,  sal.lineno, sal.sectionnm, sal.sec_bangla,
	   sal.otrate, mon.othr, per.joining_date, per.shift
