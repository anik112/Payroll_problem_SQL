...
SELECT sal.CARDNO, sal.DEPARTMENTNM, sal.DEPT_BANGLA, sal.SECTIONNM, sal.SEC_BANGLA, sal.LINENO, sal.FLOORNO, sal.MACHINENO,
       ...
       (sal.GROSSSAL_CH + sal.GROSSSAL_BK)GROSSSAL,  (sal.BASICSAL_BK + sal.BASICSAL_BK)BASICSAL,  
	   (sal.HOUSERENT_BK + sal.HOUSERENT_BK)HOUSERENT, sal.MEDICAL MEDICAL_SAL, sal.TRANSPORT, 
