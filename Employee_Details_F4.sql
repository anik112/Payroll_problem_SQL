SELECT DEPARTMENTNM, SECTIONNM, lineno, cardno, empname,  FATHER_NAME,
designation, BIRTH_DATE, joining_date, (grosssalary+GROSS_BK) GROSSSALARY
...
AND   active    LIKE DECODE(NVL(:p_active,'all'),'all','%',:p_active)
UNION
SELECT info.DEPARTMENTNM, info.SECTIONNM, info.lineno, info.cardno, info.empname,  info.FATHER_NAME,
info.designation, info.BIRTH_DATE, info.joining_date, (info.grosssalary+info.GROSS_BK) GROSSSALARY
