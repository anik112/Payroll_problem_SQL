SELECT info.cardno,info.empname,info.lineno,mapp.intime,mapp.outtime,info.designation,
              mapp.duration,mapp.latestatus,info.departmentnm,info.sectionnm
...
SELECT info.cardno,info.empname,info.lineno,mapp.intime,mapp.outtime,
       mapp.duration,mapp.latestatus,info.departmentnm,info.sectionnm, info.designation
FROM  tb_data_master mapp,tb_personal_info info 
WHERE info.company    =:p_company
AND   mapp.company     = :p_com
AND   mapp.finyear         = TO_CHAR(:p_date,'RRRR')
