SELECT COUNT(sal.cardno)total_emp, sal.sectionnm, sal.sec_bangla, sal.lineno, SUM(sal.grosssal_ch + sal.grosssal_bk)grosssal, 
               SUM(sal.basicsal_ch + sal.basicsal_bk)basicsal, SUM(sal.houserent_ch + sal.houserent_bk)houserent, 
               ...
               SUM(sal.netpayment_ch_rd + sal.netpayment_bk_rd)netpayment_rd, SUM(sal.nt_bill_ch + sal.nt_bill_pt_ch + sal.nt_bill_bk + sal.nt_bill_pt_bk)nt_bill,
               SUM(sal.tiffin_bill_ch + sal.tiffin_bill_pt_ch + sal.tiffin_bill_bk + sal.tiffin_bill_pt_bk)tiffin_bill, SUM(sal.iftar_bill_ch + sal.iftar_bill_bk)iftar_bill,
               SUM(sal.dinner_bill_ch + sal.dinner_bill_bk)dinner_bill,  SUM(gt_holi_bill_ch + gt_holi_bill_bk)gt_holi_bill, SUM(sal.wk_holi_bill_ch + sal.wk_holi_bill_bk)wk_holi_bill,
               SUM(sal.fs_bonus_ch + sal.fs_bonus_bk)fs_bonus
...
GROUP BY sal.sectionnm,sal.sec_bangla, sal.lineno 
ORDER BY sal.sectionnm,sal.lineno ASC