SELECT sal.cardno, sal.departmentnm, sal.dept_bangla, sal.sectionnm, sal.sec_bangla, sal.lineno, sal.floorno, sal.machineno,
       ...
       mon.total_day, mon.week_day, mon.govt_day, mon.casual, mon.earned, mon.medical, mon.lwp, mon.total_leave, mon.total_present, 
	   mon.total_absent, mon.total_attn_day, sal.grosssal_bk, sal.basicsal_bk, sal.houserent_bk, sal.medical medical_sal, 
	   sal.transport, sal.foodallow, sal.otherallow_bk,	 sal.total_absent_ded_bk, sal.netwages_bk, mon.late_day, sal.attbonus_bk,  
	   mon.sal_ot_hr,   sal.otrate, sal.sal_ot_amt_bk, sal.arrear_amt_bk, sal.netpayable_bk, sal.advance_amt_bk, sal.adv_sal_bk,  
	   (sal.advance_amt_bk+sal.adv_sal_bk)total_advance, sal.stamp_bk,  sal.netpayment_bk, sal.netpayment_bk_rd,
       sal.nt_bill_bk, sal.nt_bill_pt_bk, (sal.nt_bill_bk + sal.nt_bill_pt_bk)nt_bill,  sal.tiffin_bill_bk,  sal.tiffin_bill_pt_bk,  
	   (sal.tiffin_bill_bk + sal.tiffin_bill_pt_bk)tiffin_bill,sal.iftar_bill_bk, sal.dinner_bill_bk,  sal.gt_holi_bill_bk, 
	   sal.wk_holi_bill_bk, per.cash_type,  per.bank_name,  per.ac_no, per.mft_type,  per.mft_acno 
