...
SET (OTMIN)=(
	...
	WHEN (((SUBSTR(DURATION,1,INSTR(DURATION,':')-1)-10.5))*60)+SUBSTR(DURATION,INSTR(DURATION,':')+1,2) >= 415
	 	  AND (((SUBSTR(DURATION,1,INSTR(DURATION,':')-1)-10.5))*60)+SUBSTR(DURATION,INSTR(DURATION,':')+1,2) < 445 THEN 420
		  
	WHEN (((SUBSTR(DURATION,1,INSTR(DURATION,':')-1)-10.5))*60)+SUBSTR(DURATION,INSTR(DURATION,':')+1,2) >= 445
	 	  AND (((SUBSTR(DURATION,1,INSTR(DURATION,':')-1)-10.5))*60)+SUBSTR(DURATION,INSTR(DURATION,':')+1,2) < 476 THEN 450
		  
	WHEN (((SUBSTR(DURATION,1,INSTR(DURATION,':')-1)-10.5))*60)+SUBSTR(DURATION,INSTR(DURATION,':')+1,2) >= 476
	 	  AND (((SUBSTR(DURATION,1,INSTR(DURATION,':')-1)-10.5))*60)+SUBSTR(DURATION,INSTR(DURATION,':')+1,2) < 506 THEN 480
		  
	WHEN (((SUBSTR(DURATION,1,INSTR(DURATION,':')-1)-10.5))*60)+SUBSTR(DURATION,INSTR(DURATION,':')+1,2) >= 506
	 	  AND (((SUBSTR(DURATION,1,INSTR(DURATION,':')-1)-10.5))*60)+SUBSTR(DURATION,INSTR(DURATION,':')+1,2) < 537 THEN 510
		  
	WHEN (((SUBSTR(DURATION,1,INSTR(DURATION,':')-1)-10.5))*60)+SUBSTR(DURATION,INSTR(DURATION,':')+1,2) >= 537
	 	  AND (((SUBSTR(DURATION,1,INSTR(DURATION,':')-1)-10.5))*60)+SUBSTR(DURATION,INSTR(DURATION,':')+1,2) < 567 THEN 540
		  
	WHEN (((SUBSTR(DURATION,1,INSTR(DURATION,':')-1)-10.5))*60)+SUBSTR(DURATION,INSTR(DURATION,':')+1,2) >= 567
	 	  AND (((SUBSTR(DURATION,1,INSTR(DURATION,':')-1)-10.5))*60)+SUBSTR(DURATION,INSTR(DURATION,':')+1,2) < 595 THEN 570
		 
	WHEN (((SUBSTR(DURATION,1,INSTR(DURATION,':')-1)-10.5))*60)+SUBSTR(DURATION,INSTR(DURATION,':')+1,2) >= 595
	 	  AND (((SUBSTR(DURATION,1,INSTR(DURATION,':')-1)-10.5))*60)+SUBSTR(DURATION,INSTR(DURATION,':')+1,2) < 627 THEN 600 
		  
	WHEN (((SUBSTR(DURATION,1,INSTR(DURATION,':')-1)-10.5))*60)+SUBSTR(DURATION,INSTR(DURATION,':')+1,2) >= 627
	 	  AND (((SUBSTR(DURATION,1,INSTR(DURATION,':')-1)-10.5))*60)+SUBSTR(DURATION,INSTR(DURATION,':')+1,2) < 656 THEN 630
		  
	WHEN (((SUBSTR(DURATION,1,INSTR(DURATION,':')-1)-10.5))*60)+SUBSTR(DURATION,INSTR(DURATION,':')+1,2) >= 656
	 	  AND (((SUBSTR(DURATION,1,INSTR(DURATION,':')-1)-10.5))*60)+SUBSTR(DURATION,INSTR(DURATION,':')+1,2) < 685 THEN 660
		  
	WHEN (((SUBSTR(DURATION,1,INSTR(DURATION,':')-1)-10.5))*60)+SUBSTR(DURATION,INSTR(DURATION,':')+1,2) >= 685
	 	  AND (((SUBSTR(DURATION,1,INSTR(DURATION,':')-1)-10.5))*60)+SUBSTR(DURATION,INSTR(DURATION,':')+1,2) < 718 THEN 690
		  
	WHEN (((SUBSTR(DURATION,1,INSTR(DURATION,':')-1)-10.5))*60)+SUBSTR(DURATION,INSTR(DURATION,':')+1,2) >= 718
	 	  AND (((SUBSTR(DURATION,1,INSTR(DURATION,':')-1)-10.5))*60)+SUBSTR(DURATION,INSTR(DURATION,':')+1,2) < 745 THEN 720
		  
	WHEN (((SUBSTR(DURATION,1,INSTR(DURATION,':')-1)-10.5))*60)+SUBSTR(DURATION,INSTR(DURATION,':')+1,2) >= 745
	 	  AND (((SUBSTR(DURATION,1,INSTR(DURATION,':')-1)-10.5))*60)+SUBSTR(DURATION,INSTR(DURATION,':')+1,2) < 776 THEN 750
		  
	WHEN (((SUBSTR(DURATION,1,INSTR(DURATION,':')-1)-10.5))*60)+SUBSTR(DURATION,INSTR(DURATION,':')+1,2) > 776
	 	  AND (((SUBSTR(DURATION,1,INSTR(DURATION,':')-1)-10.5))*60)+SUBSTR(DURATION,INSTR(DURATION,':')+1,2) < 805 THEN 780

	WHEN (((SUBSTR(DURATION,1,INSTR(DURATION,':')-1)-10.5))*60)+SUBSTR(DURATION,INSTR(DURATION,':')+1,2) >= 805
	 	  AND (((SUBSTR(DURATION,1,INSTR(DURATION,':')-1)-10.5))*60)+SUBSTR(DURATION,INSTR(DURATION,':')+1,2) < 840 THEN 810 
