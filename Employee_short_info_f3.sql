SELECT cardno, empname, designation, BIRTH_DATE, joining_date, (GROSSSALARY + GROSS_BK) grosssalary, lineno, SECTIONNM, DEPARTMENTNM
...
AND    active  LIKE DECODE(NVL(:p_active,'all'),'all','%',:p_active)
UNION
SELECT emp.cardno, emp.empname, emp.designation, emp.BIRTH_DATE, emp.joining_date, (emp.GROSSSALARY + emp.GROSS_BK) grosssalary, emp.lineno, emp.SECTIONNM, emp.DEPARTMENTNM
