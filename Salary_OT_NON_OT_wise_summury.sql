SELECT COUNT(sal.cardno)total_emp_n, sal.sectionnm ectionnm_n, sal.sec_bangla sec_Bangla_n, SUM(sal.grosssal_ch + sal.grosssal_bk)grosssal_n, 
               ...
               SUM(sal.netpayment_ch_rd + sal.netpayment_bk_rd)netpayment_rd_n
...
SELECT COUNT(sal.cardno)total_emp_y, sal.sectionnm ectionnm_y, sal.sec_bangla sec_Bangla_y, SUM(sal.grosssal_ch + sal.grosssal_bk)grosssal_y, 
               ...
               SUM(sal.netpayment_ch_rd + sal.netpayment_bk_rd)netpayment_rd_y
FROM   tb_month_salary sal,tb_month_totalday  mon, tb_personal_info per 
WHERE  per.company    = :p_company 
