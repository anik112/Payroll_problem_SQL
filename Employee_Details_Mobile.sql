SELECT SECTIONNM,DEPARTMENTNM, lineno, cardno, empname, designation, BIRTH_DATE, joining_date, (grosssalary + GROSS_BK) grosssalary,  MOBILE Mobile_Bill
...
AND   active    LIKE DECODE(NVL(:p_active,'all'),'all','%',:p_active)
UNION
SELECT info.SECTIONNM,info.DEPARTMENTNM, info.lineno, info.cardno, info.empname, info.designation,
info.BIRTH_DATE, info.joining_date, (info.grosssalary + info.GROSS_BK) grosssalary,  info.MOBILE Mobile_Bill
